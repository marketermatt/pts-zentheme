...
if (function_exists('register_sidebar'))
    register_sidebar(array(
        ...
        'description' => __('Left column with an active area of 180 pixels wide for your blog', 'pts' ),
...
if (function_exists('register_sidebar'))
    register_sidebar(array(
        ...
        'description' => __('Blog inset column with an active area of 180 pixels wide for your blog', 'pts' ),
        'before_widget' => '<div id="%1$s" class="widget">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
if (function_exists('register_sidebar'))
    register_sidebar(array(
        ...
        'description' => __('Right Column with an active area of 240 pixels wide for your blog', 'pts' ),
        'before_widget' => '<div id="%1$s" class="widget">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
if (function_exists('register_sidebar'))
    register_sidebar(array(
        ...
        'description' => __('Left column with an active area of 180 pixels wide for your page', 'pts' ),
        'before_widget' => '<div id="%1$s" class="widget">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
if (function_exists('register_sidebar'))
    register_sidebar(array(
        ...
        'description' => __('Right Column with an active area of 240 pixels wide for your page', 'pts' ),
        'before_widget' => '<div id="%1$s" class="widget">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
if (function_exists('register_sidebar'))
    register_sidebar(array(
        ...
        'description' => __('This is a Showcase widget area for you to use for full width images, media, or even your own slideshows throughout your web site. For this, use the Custom No Title Widget.', 'pts' ),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '',
        'after_title' => '',
...
if (function_exists('register_sidebar')) {
    /*register_sidebar(array(
        'name' => 'Top Widget',
        'description' => __('Top widget that is below the Showcase and breadcrumbs navigation - full width widget or use shortcode for columns - if supported.', 'pts' ),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h2>',
        'after_title' => '</h2>',
...
// Bottom Widgets with dynamic auto width adjustments. Special thanks to www.shibashake.com for this widget plugin
    $bottom_sidebar = register_sidebar(array('name' => 'Bottom Widgets',
        'description' => __('This puts 1, 2, 3, or 4 widgets side-by-side in the bottom area of your page above the footer and will automatically resize based on how many widgets are published.', 'pts' ),
...
class pixel_text_widget extends WP_Widget
{
    ...
    function pixel_text_widget()
    {
        $widget_ops = array('classname' => 'pixel_text_widget', 'description' => __('Custom text widget that has a wider field to enter content and also supports shortcode. Best for doing multiple column shortcodes.', 'pts'));
...
// my custom setting to show or not show title
    ...
    function form($instance)
    {
        ...
        ?>
        <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'pts'); ?></label>
        ...
        <p><input id="<?php echo $this->get_field_id('filter'); ?>"
                ...
                for="<?php echo $this->get_field_id('filter'); ?>"><?php _e('Automatically add paragraphs', 'pts'); ?></label>
        </p>
    <?php
    }
}
...
//$instance['$text'] = stripslashes($new_instance['text']);
    ...
    function form($instance)
    {
        ...
        <p><label
                for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title for the admin side only', 'hybrid'); ?></label>
            <input id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>"
                   value="<?php echo $instance['title']; ?>" style="width:100%;"/>
        </p>

        <p><label
                for="<?php echo $this->get_field_id('title2'); ?>"><?php _e('Title for the front of your site - leave blank for no title', 'hybrid'); ?></label>
        ...
        <p><label
                for="<?php echo $this->get_field_id('link'); ?>"><?php _e('Full URL to link image or text to:', ''); ?></label>
        ...
        <p><label
                for="<?php echo $this->get_field_id('link_text'); ?>"><?php _e('ALT text for the image):', ''); ?></label>
        ...
        <p><label
                for="<?php echo $this->get_field_id('text'); ?>"><?php _e('If you want to use this for a special text widget with content, enter in text you would like to display. HTML is allowed but Shortcodes is not compatible in this one.', ''); ?></label>
